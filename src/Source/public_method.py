...
class Config():
    ...
    def __init__(self):
        ...
        self.logDir = projectPath + "/" + 'log'  # 日志输出路径
        self.screenDir = projectPath + "/" + 'screen'  # 截图输出路径
        self.reportDir = projectPath + "/" + 'report'  # 测试报告输出路径
        self.csvDir = projectPath + "/" + 'csv'  # csv配置文件路径
        self.testDir = projectPath + "/" + 'src/TestCase'  # 测试用例文件路径
